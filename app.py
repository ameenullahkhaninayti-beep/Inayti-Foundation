...
def home():
    ...
    # 2. Main Interface HTML & Styled Framework
    html_content = f"""
    <!DOCTYPE html>
    <html>
    <head>
        ...
        <style>
            ...
            .form-group input:focus, .form-group textarea:focus {{ outline: none; border-color: #007bff; box-shadow: 0 0 0 3px rgba(0,123,255,0.15); }}
            ...
            .radio-row label {{ cursor: pointer; font-size: 15px; }}
            
            button {{ background-color: #007bff; color: white; border: none; padding: 14px 24px; border-radius: 6px; font-size: 16px; font-weight: bold; width: 100%; cursor: pointer; transition: background-color 0.2s; box-shadow: 0 2px 4px rgba(0,123,255,0.2); }}
            ...
            .result-container {{ margin-top: 35px; padding: 25px; background-color: #f3faf6; border-left: 6px solid #28a745; border-radius: 8px; border-top: 1px solid #d4edda; border-right: 1px solid #d4edda; border-bottom: 1px solid #d4edda; }}
    ...
    <body>
        ...
        <div class="navbar">
            <a href="/?tab=home" class="{"active" if current_tab == "home" else ""}">Program Assessment</a>
    ...
    if current_tab == "home":
        ...
        # If user submitted the evaluation, inject the custom green summary container right under the form
    ...
    # ================= TAB CONTENT #3: CONTACT US PAGE =================
    elif current_tab == "contact":
        if contact_submitted:
            html_content += f"""
                <div class="success-banner">
                    ✔ Message Dispatched! Thank you, {contact_name}. The Youth Foundation intake office has registered your inquiry and will respond to {contact_email} within 24 business hours.
                </div>
            """
        ...
        html_content += f"""
                ...
                <a href="https://wa.me/91{PHONE_NUMBER}?text=Hello%20Founder%20Ameen%20Ullah%20Khan,%20I%20visited%20your%20website%20and%20want%20to%20connect." target="_blank" class="btn-social btn-whatsapp">
                    <i class="fab fa-whatsapp"></i> Chat instantly on WhatsApp (+91 {PHONE_NUMBER})
                </a>

                <a href="mailto:{GMAIL_ID}?subject=Youth%20Foundation%20Inquiry" class="btn-social btn-email">
                    <i class="far fa-envelope"></i> Open Mail Client ({GMAIL_ID})
                </a>
    ...
    # Append closing footer structural elements
    html_content += """
            </div>
